                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <strong>Total Price:</strong> {{$trip->sum_of_prices}}<br>
                            </div>
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    @foreach($trip->flights as $index=>$flight)
                                        ...
                                        <li>Flight Departure Time: {{ $flight->departure_time."(".$flight->departureAirport->timezone.")" }}</li>
                                        <li>Flight Arrival Time: {{ $flight->arrival_time. "(".$flight->arrivalAirport->timezone. ")"}}</li>
